...
class TiktokSearch extends Component {
    ...
    componentDidMount() {
        ...
        this.setState({
            ...
            let tmpDataList = reactLocalStorage.get('tmpData-tiktokhashtag');
            if (tmpDataList) {
            ...
            let tmpReq = reactLocalStorage.get('tmpReq-tiktokhashtag');
                        ...
                        if (success.code === '200') {
                            ...
                            if (dataPost) {
                                ...
                                this.setState({ showData: final, data: final, cursors: tmpRequest.cursor, offset: tmpRequest.offset, tmpReq: tmpRequest, hasMore: dataResponse.has_more, maxCursor: dataResponse.cursor ? dataResponse.cursor : 0 }, () => {
                                    ...
                                    reactLocalStorage.set('tmpData-tiktokhashtag', JSON.stringify(tmpDataList));
                                    reactLocalStorage.set('tmpReq-tiktokhashtag', JSON.stringify(tmpRequest));
                                });
                                if (this.state.sorts !== '') {
                                    this._onChangeSort({ target: { value: this.state.sorts } });
                                }
                        ...
                        <div className="card">
                            <div className='row p-3 pr-4'>
                                <div className="col-6 col-md-4 mb-3">
                                    ...
                                    {
                                        emptyKeyword ? (
                                            <label style={{ color: "red", fontSize: 14, marginTop: 10 }}>Hashtag required! <br />Press Key "Enter" or "Space" to input the tag</label>
                                        ) : null
                                    }
                                </div>
                                ...
                                <div className='col-12'>
                                    <div className='alert alert-info'>
                                        <p>Note : Please search for hashtags in the language of the country you've entered. If you select a country, you will get a more precise search, but with less content
                                        </p>
                                    </div>
                                </div>
                            </div>
